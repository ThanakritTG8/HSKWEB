...
<script>
    $(function() {
        ...
        $('#pretest-btn-1').click(() => {
        sound.src = `../../sound/post-test/hsk2/HSK_2_PostTest_${session}_Part_1.mp3`;
        sound.play();
        });
        $('#pretest-btn-2').click(() => {
        sound.src = `../../sound/post-test/hsk2/HSK_2_PostTest_${session}_Part_2.mp3`;
        sound.play();
        });
        $('#pretest-btn-3').click(() => {
        sound.src = `../../sound/post-test/hsk2/HSK_2_PostTest_${session}_Part_3.mp3`;
        sound.play();
        });
        $('#pretest-btn-4').click(() => {
        sound.src = `../../sound/post-test/hsk2/HSK_2_PostTest_${session}_Part_4.mp3`;
        sound.play();
        });
