            ...
            <form id="part1_3">
                <table class="table table-bordered text-center responsive">
                    <tr>
                        ...
                        <td scope="col" class="text-start" style="padding-top: 35px;" id="part3_choice1">
                        </td>
                    </tr>
                    <tbody id="sesion3">
                    </tbody>
            ...
            <form id="part2_2">
                <table class="table table-bordered text-center responsive">
                    <tr>
                        ...
                        <td scope="col" class="text-start" style="padding-top: 20px;" id="part2_2_choice1">
            ...
            <form id="part2_3">
                <table class="table table-bordered text-center responsive">
                    <tr>
                        ...
                        <td scope="col" class="text-start">
                            <div id="part2_3_choice1" class="pin-in pl-1"></div>
            ...
            <form id="part2_4">
                <table class="table table-bordered text-center responsive">
                    <tr>
                        ...
                        <td scope="col" class="text-start">
                            <div id="part2_4_choice1" class="pin-in pl-2"></div>
...
<script>
    $(function() {
        ...
        $.getJSON("posttest_hsk1.json", function(result) {
            ...
            $("#sesion1").html(data);
            //// ส่วนที่2
            const part2 = dataSession.listen.part2;
            const data_part2 = [];
            ...
            //// ส่วนที่3
            const part3 = dataSession.listen.part3.choice;
            const answer = dataSession.listen.part3.answer;
            const data_part3 = [];
            answer.forEach((e, i) => {
                let td = `<tr>
            ...
            const part2_1 = dataSession.reading.part1;
            //// ส่วนที่1 การอ่าน
            const data_part2_1 = [];
            part2_1.forEach((e, i) => {
                let setAnswer = [];
            ...
            //// ส่วนที่3 การอ่าน
            const part2_3 = dataSession.reading.part3.topic;
            const choice2_3 = dataSession.reading.part3.choice;
            const answer2_3 = dataSession.reading.part3.answer;
            const data_part2_3 = [];
            part2_3.forEach((e, i) => {
                let td = `<tr>
            ...
            //// ส่วนที่4 การอ่าน
            const part2_4 = dataSession.reading.part4.topic;
            const choice2_4 = dataSession.reading.part4.choice;
            const answer2_4 = dataSession.reading.part4.answer;
            const data_part2_4 = [];
            part2_4.forEach((e, i) => {
                let td
                if (e.pinin_end || e.ch_end) {
                    if (e.pinin_sec || e.ch_sec) {
                        if (e.pinin_end) {
                            td = `<tr>
            ...
            $.fn.countScore = function() {
                ...
                console.log(sum_part1,sum_part_2,sum_part_3,sum_part_4);
                console.log(sum_part2_1,sum_part2_2,sum_part2_3,sum_part2_4);
                ///send score
