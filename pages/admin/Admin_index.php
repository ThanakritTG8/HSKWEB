  ...
  <div class="container">
      <div class="card text-center">
          <div class="card-body">
              ...
              <a href="score.php" class="btn btn-success-admin btn-success">ดูคะแนน</a>
          </div>
      </div>
      <div class="card text-center">
          <div class="card-body">
      ...
      <div class="card text-center">
          <div class="card-body">
              <h5 class="card-title">HSK Account </h5>
              <img src="../../img/personal-information.png" alt="" class="img-card"><br>

              <a href="teacher.php" class="btn btn-success-admin btn-success">HSK Account</a>
          </div>
      </div>
  </div>
