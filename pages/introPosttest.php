...
<body>
    <?php if(isset($_GET['hsk'])&&isset($_GET['session'])) :?>
    <div class="container">
        ...
        <div class="card text-center">
            ...
            if ($hsk == 1) : ?>
                <div class="card-header">
                    <div>HSK（一级）课后自测</div>
                    <div>【แบบทดสอบหลังเรียน (Post-test_<?= $session; ?>) HSK 1】</div>
                </div>
            ...
            <?php else : ?>
                <div class="card-header">
                    <div>HSK（二级）课前自测</div>
                    <div>【แบบทดสอบหลังเรียน (Post-test_<?= $session; ?>) HSK 2】</div>
                </div>
                <div class="card-body text-left">
