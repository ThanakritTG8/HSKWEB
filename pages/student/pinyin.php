...
<body id="body">
    ...
    <header class="masthead">
        <div class="jumbotron jumbotron-fluid" id="header">
            <h1 class="text-center m-3">汉语拼音</h1>
            <h1 class="text-center m-3">Hànyǔ Pīnyīn</h1>
            <h1 class="text-center m-3">การสะกดเสียงภาษาจีน (พินอิน)</h1>
        </div>
    </header>
                ...
                <div class="card text-left" id="pinyin-body">
                    <div class="card-body">
                        ...
                        <div class="" id="box">
                            ...
                            <button onclick="play('z')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(233, 124, 0);">z
                                (จือ)</button>
                            <audio id="z" src="/sound//pinyin1/z.mp3"></audio>
                            <button onclick="play('c')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(233, 124, 0);">c
                                (ชือ)</button>
                            <audio id="c" src="/sound//pinyin1/c.mp3"></audio>
                            <button onclick="play('s')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(233, 124, 0);">s
                                (ซือ) *</button>
                        ...
                        <div class="" id="box">
                            ...
                            <button onclick="play('zh')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(222, 115, 255);">zh
                                (จรือ)</button>
                            <audio id="zh" src="/sound/pinyin1/zh.mp3"></audio>
                            <button onclick="play('ch')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(222, 115, 255);">ch
                                (ชรือ)</button>
                            <audio id="ch" src="/sound/pinyin1/ch.mp3"></audio>
                            <button onclick="play('sh')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(222, 115, 255);">sh
                                (ซรือ)</button>
                            <audio id="sh" src="/sound/pinyin1/sh.mp3"></audio>
                            <button onclick="play('r')" type="button" id="btn-pinyin" class="btn"
                                style="background: rgb(222, 115, 255);">r
                                (รือ)</button>
                            ...
                            <div class="card text-left" style="background: rgb(255, 205, 205);">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><b class="text-danger">1) สีแดง </b>ออกเสียงต่างจากภาษาอังกฤษ
                                        ...
                                        ออกเสียง <b class="text-danger">โป</b> ไม่ใช่ โบ และ <b
                                            class="text-danger">d</b> ออกเสียง <b class="text-danger">เตอ</b> ไม่ใช่ เดอ
                                    </p>
                            ...
                            <div class="row" id="box">
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <button onclick="play('a')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                            ...
                                            <td>
                                                <button onclick="play('o')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                            ...
                                            <td>
                                                <button onclick="play('e')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                            ...
                                            <td>
                                                <button onclick="play('i')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                            ...
                                            <td>
                                                <button onclick="play('u')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                            ...
                                            <td>
                                                <button onclick="play('ü')" type="button" id="btn-pinyin"
                                                    class="btn btn-light">
                                ...
                                <div class="row" id="box">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <button onclick="play('ai')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ou')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ei')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ia')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ua')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('üe')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                        <b class="text-danger">ü</b><b
                                                            style="color: rgb(36, 18, 197);">e</b>
                                                        (<b class="text-danger">อวี</b><b
                                                            style="color: rgb(36, 18, 197);">เอ</b>)
                                                    </button>
                                            ...
                                            <tr>
                                                <td>
                                                    <button onclick="play('ao')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ong')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('en')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('uai')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('üan')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                <td>
                                                    <button onclick="play('an')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('eng')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('iao')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('uan')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ün')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                <td>
                                                    <button onclick="play('ang')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('er')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ian')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('uang')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('iang')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('uo')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('ie')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                        <b class="text-danger">i</b><b
                                                            style="color: rgb(36, 18, 197);">e</b>
                                                        (<b class="text-danger">อี</b><b
                                                            style="color: rgb(36, 18, 197);">เย</b>)
                                                    </button>
                                                    <audio id="ie" src="/sound/pinyin2/ie.mp3"></audio>
                                                </td>
                                                <td>
                                                    <button onclick="play('uei_ui')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('iou_iu')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('uen_un')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('in')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                                ...
                                                <td>
                                                    <button onclick="play('ueng')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('ing')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button onclick="play('iong')" type="button" id="btn-pinyin"
                                                        class="btn btn-light">
                ...
                <div class="card text-left" id="pinyin-body">
                    <div class="card-body">
                        ...
                        <div class="" id="box">
                            ...
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;
                                j<b class="text-danger">i</b><b style="color: rgb(255, 123, 0);">ā</b> x<b
                                    class="text-danger">i</b><b style="color: rgb(255, 123, 0);">ě</b>
                                p<b class="text-danger">i</b><b style="color: rgb(255, 123, 0);">ā</b>o d<b
                                    style="color: rgb(255, 123, 0);">i</b><b style="color: rgb(255, 123, 0);">à</b>n
                                j<b class="text-danger">i</b><b style="color: rgb(255, 123, 0);">ù</b> zh<b
                                    class="text-danger">u</b><b style="color: rgb(255, 123, 0);">ā</b>
                                ch<b class="text-danger">u</b><b style="color: rgb(255, 123, 0);">à</b>ng sh<b
                                    class="text-danger">u</b><b style="color: rgb(255, 123, 0);">á</b>i
                                q<b class="text-danger">u</b><b style="color: rgb(255, 123, 0);">ē</b> y<b
                                    class="text-danger">u</b><b style="color: rgb(255, 123, 0);">á</b>n
                                l<b class="text-danger">ü</b><b style="color: rgb(255, 123, 0);">è</b>
                            </p>
                            <p>
                                <li>หากเติมบนสระ <b class="text-danger">i</b>
                                    ให้ตัดจุดออก เช่น b<b class="text-danger">ǐ</b> m<b class="text-danger">í</b>n t<b
                                        class="text-danger">ī</b>ng
                                </li>
                            </p>
                            ...
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;
                                <b class="text-primary">j</b><b class="text-danger">ǖ</b>n เขียนเป็น <b
                                    class="text-primary">j</b><b class="text-danger">ū</b>n
                                <b class="text-primary">q</b><b class="text-danger">ü</b>àn เขียนเป็น <b
                                    class="text-primary">q</b><b class="text-danger">u</b>àn
                                <b class="text-primary">x</b><b class="text-danger">ü</b>é เขียนเป็น <b
                                    class="text-primary">x</b><b class="text-danger">u</b>é
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card text-left" id="pinyin-body">
                    <div class="card-body">
                        ...
                        <div style="overflow-x: scroll;" id="box">
                            <h5 class="header">
                                “<b class="text-danger">เสียง 3</b>”(<b class="text-danger">ˇ</b>) ออกเสียงเหมือน “<b
                                    class="text-danger">เสียงเอก + เสียงจัตวา</b>” ของไทย)
                            </h5>

                            <p class="title">
                                <li>เมื่อ “<b class="text-danger">เสียง 3</b>” (<b class="text-danger">ˇ</b>)
                                    ตามด้วย “<b style="color: darkviolet;">เสียง 1(ˉ), 2(ˊ) และ 4(ˋ)</b>”
                                    ให้อ่าน “<b class="text-danger">ครึ่งเสียง 3</b>” (เหมือน “<b
                                        class="text-danger">เสียงเอก</b>” ของไทย) เช่น
                                </li>
                            </p>
                            ...
                            <p class="title">
                                <li>
                                    ...
                                    <ol>
                                        1. ซ้อนกัน 2 พยางค์【ˇ + ˇ = ˊ + ˇ】ให้อ่านพยางค์แรกเป็น “<b
                                            class="text-danger">เสียง
                            ...
                            <ol>
                                ...
                                <ol>
                                    ...
                                    <b style="color: darkviolet;">1</b> และ <b style="color: darkviolet;">2</b> เป็น <b
                                        class="text-danger">“เสียง 2” (ˊ)</b> เช่น
                                </ol>
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            <td style="width: 500px;">
                                                ...
                                                <b style="color: darkviolet;">zhǎnlǎn</b><b
                                                    class="text-primary">guǎn</b>
                                                (<b style="color: darkviolet;">จ่านหล่าน</b><b
                                                    class="text-primary">ก่วน</b>)
                                                <b class="text-primary">หอ</b><b
                                                    style="color: darkviolet;">นิทรรศการ</b>

                                            </td>
                                            <td style="">อ่านเป็น</td>
                                            <td>
                                                <button onclick="play('zhán_lán_guǎn')" class="btn btn-light"
                                                    id="laoshi">
                                                ...
                                                <audio id="zhán_lán_guǎn"
                                                    src="/sound/pinyin6/zhán lán guǎn.mp3"></audio>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <ol>
                                    2.2 【ˇ + ˇ ˇ = ˇ + ˊ ˇ】คำแรก 1 พยางค์ คำหลัง 2 พยางค์ ให้อ่าน พยางค์ที่ <b
                                        class="text-primary">2</b> เป็น
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 500px;">
                                                ...
                                                <b style="color: darkviolet;">xiǎo </b><b
                                                    class="text-primary">lǎobǎn</b>
                                                (<b style="color: darkviolet;">เซี่ยว</b><b
                                                    class="text-primary">หล่าวป่าน</b>)
                                                <b class="text-primary">เถ้าแก่</b><b
                                                    style="color: darkviolet;">น้อย</b>
                                            </td>
                                            <td style="">อ่านเป็น</td>
                                            <td>
                                ...
                                <ol>
                                    2.3) 【ˇ + ˇ + ˇ = ˊ + ˊ + ˇ】3 คำ 3 พยางค์ (คำละ 1 พยางค์) ให้อ่าน พยางค์ที่<b
                                        style="color: darkviolet;"> 1</b> และ <b class="text-primary">2</b> เป็น
                                    <b class="text-danger">“เสียง 2” (ˊ)</b> เช่น
                                </ol>
                                <table class="table table-borderless">
                                    <tbody>
                                        <tr>
                                            <td style="width: 500px;">
                                                <b style="color: darkviolet;">我</b><b class="text-primary">很</b><b
                                                    class="text" style="color: darkgreen;">好</b>
                                                <b style="color: darkviolet;">我</b><b class="text-primary">hěn</b><b
                                                    class="text" style="color: darkgreen;">hǎo</b>
                                                (<b style="color: darkviolet;">หว่อ</b><b
                                                    class="text-primary">เหิ่น</b><b class="text"
                                                    style="color: darkgreen;">ห่าว</b>)
                                                <b style="color: darkviolet;">ฉัน</b><b class="text"
                                                    style="color: darkgreen;">สบายดี</b><b class="text-primary">มาก</b>
                                            </td>
                                            <td style="">อ่านเป็น</td>
                                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="play('bú_shi')" class="btn btn-light" id="laoshi">
                                                ...
                                                (<b class="text-danger">ปู๋ </b><b
                                                    style="color: darkolivegreen;">ซื่อ</b>)
                                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="play('bú_cuò')" class="btn btn-light" id="laoshi">
                                                ...
                                                (<b class="text-danger">ปู๋ </b><b
                                                    style="color: darkolivegreen;">ชั่ว</b>)
                                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="play('yí_cì')" class="btn btn-light" id="laoshi">
                                                ...
                                                (<b class="text-danger">อี๋ </b><b
                                                    style="color: darkolivegreen;">ชื่อ</b>)
                                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button onclick="play('yí_bàn')" class="btn btn-light" id="laoshi">
                                                ...
                                                (<b class="text-danger">อี๋ </b><b
                                                    style="color: darkolivegreen;">ปั้น</b>)
                                            </button>
